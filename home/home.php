...
<body>
    ...
    <div class="chamada">
        ...
        <br>
        <p>Na PoloFIT, cada treino é um passo em direção aos seus objetivos. <br>Descubra a força que existe em você e transforme sua determinação em resultados.</p>
    </div>
